...
namespace RedCell.Diagnostics.Update
{
    public class Updater
    {
        ...
        /// </summary>
        public const string DefaultConfigFile = "XML/update.xml";
        ...
        private void Check (object state)
        {
            ...
            DialogResult dialogResult = MessageBox.Show("There's a new version " + _remoteConfig.Version + " available, update CustomActorToolkit?", "Update", MessageBoxButtons.YesNo);
